        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text("Update Warranty Invoice Samples"),
              subtitle: const Text("Push sample warranty invoice data to Firestore"),
              onTap: () async {
                Navigator.pop(context);
                try {
                  await pushWarrantyInvoiceSampleData();
                  scaffoldMessenger.showSnackBar(
                    const SnackBar(content: Text("Warranty invoice samples updated successfully")),
                  );
                } catch (e) {
                  scaffoldMessenger.showSnackBar(
                    SnackBar(content: Text("Error: ${e.toString()}")),
